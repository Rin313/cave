...
import type { Entity, World } from "../../src/core/sim.ts";
...
export const space = (core: Core) => {
	...
	function inTreeReach(world: World, anchor: string, id: string, des: (e: Entity) => string, opts: SpaceOpts = {}): { ok: boolean; reason: string } {
	...
	function enclosingSpace(world: World, id: string): string | null {
	...
	function hostOf(world: World, anchor: string, opts: SpaceOpts = {}): string {
	...
	function inTreeVisible(world: World, anchor: string, des: (e: Entity) => string, opts: SpaceOpts = {}): Set<string> {
	...
	return { inTreeReach, enclosingSpace, hostOf, inTreeVisible };
};
